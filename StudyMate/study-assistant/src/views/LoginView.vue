...
.auth-left {
    ...
    overflow: hidden;
    background:
        radial-gradient(circle at 18% 18%, rgba(217, 174, 118, 0.30), transparent 30%),
        radial-gradient(circle at 85% 78%, rgba(185, 130, 76, 0.22), transparent 29%),
        linear-gradient(140deg, #332720 0%, #5a4030 52%, #b9824c 100%);
    display: flex;
...
.hero-badge {
    ...
    padding: 8px 13px;
    border-radius: 24px;
    background: rgba(255, 246, 233, 0.13);
    color: #f1ddc4;
    font-size: 13px;
    font-weight: 600;
    display: flex;
...
.feature-icon {
    ...
    border-radius: 14px;
    color: white;
    background: rgba(217, 174, 118, 0.2);
    font-size: 22px;
    display: flex;
    justify-content: center;
    align-items: center;
