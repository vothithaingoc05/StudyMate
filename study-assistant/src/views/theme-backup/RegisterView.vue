...
.register-page {
    ...
    padding: 34px;
    background:
        radial-gradient(circle at 90% 10%, #e0e7ff, transparent 28%),
        radial-gradient(circle at 10% 90%, #ede9fe, transparent 26%),
        #f8fafc;
    display: flex;
    align-items: center;
...
.decoration-card {
    ...
    border-radius: 28px;
    color: white;
    background: linear-gradient(145deg, #312e81, #6366f1, #7c3aed);
    box-shadow: 0 26px 55px rgba(79, 70, 229, 0.24);
}
